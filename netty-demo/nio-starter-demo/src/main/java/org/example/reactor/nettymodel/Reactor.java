...
public class Reactor implements Runnable, Closeable {
    ...
    public Reactor(int workCount, ChannelHandler child) {
        this(workCount);
    ...
    public void run() {
        try{
            ...
            serverSocketChannel.register(selector, SelectionKey.OP_ACCEPT,new Acceptor(serverSocketChannel,subReactorNum, childHandler));
