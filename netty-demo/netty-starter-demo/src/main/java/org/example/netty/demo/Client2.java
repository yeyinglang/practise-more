...
//                                super.channelRead(ctx, msg);
        ...
        ChannelFuture connect = bootstrap.connect("localhost",8090);
        connect.channel().writeAndFlush(Unpooled.wrappedBuffer("hello i am client2".getBytes(StandardCharsets.UTF_8)));
